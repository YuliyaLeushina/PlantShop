(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".swiper", {
            ...
            renderFraction: function(currentClass, totalClass) {
                return 'Фото <span class="' + currentClass + '">lorem</span>' + " из " + '<span class="' + totalClass + '">jhfk</span>';
            },
            navigation: {
                prevEl: ".top__button_prew",
                nextEl: ".top__button_next"
            },
            on: {
                slideChangeTransitionStart: function() {
                    let nextTitle = document.querySelector(".swiper-slide-next").querySelector(".top__title");
                    let textTitle = nextTitle.textContent;
                    document.getElementById("next").innerHTML = textTitle;
                },
                slideChangeTransitionEnd: function() {
                    let prewTitle = document.querySelector(".swiper-slide-prev").querySelector(".top__title");
                    let textTitlePrew = prewTitle.textContent;
                    document.getElementById("prew").innerHTML = textTitlePrew;
                }
            }
        });
    }
    ...
    var btnCard = document.getElementById("buton");
    var toggle = false;
    document.querySelector(".card__btn").addEventListener("click", (() => {
        document.querySelector(".card__arrow").classList.toggle("card__arrow_up");
    }));
    btnCard.addEventListener("click", (function() {
        ...
        items.forEach((function(item, indx) {
            var itemValue = parseInt(item.querySelector(".card__price").textContent.replace("руб", "").replace(/\s+/g, ""));
    ...
    document.addEventListener("click", (e => {
        ...
        if (!withinBoundaries) searchForm.classList.remove("_active");
    }));
    window["FLS"] = true;
    isWebp();
    formFieldsInit({
