        ...
        if (document.querySelector(".swiper")) new core(".swiper", {
            ...
            on: {
                ...
                transitionEnd: function() {
                    const nextTitle = document.querySelector(".swiper-slide-next").querySelector(".top__title");
                    if (nextTitle.length > 0) document.querySelector(".top__plant").text(nextTitle);
                }
            }
        });
    }
